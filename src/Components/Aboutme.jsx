...
import { SiTailwindcss, SiMongodb, SiExpress, SiCplusplus, SiBootstrap, SiMui } from 'react-icons/si';
...
const AboutMe = () => {
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      if (textRef.current) {
        textRef.current.style.transform = 'perspective(1000px) rotateY(0deg) rotateX(0deg) translateZ(0px)';
      }
    };
    ...
    <>
          ...
          <div className="relative group">
            ...
            <div className="relative px-6 py-8 bg-black/50 backdrop-blur-sm rounded-lg leading-none">
              <p className="text-lg md:text-2xl text-gray-200 font-medium text-center leading-relaxed">
                I'm a <span className="text-purple-400 font-semibold">3<sup>rd</sup> year B.Tech ECE student</span> at 
                <span className="text-blue-400 font-semibold"> Sasi Institute of Technology & Engineering</span>, Tadepalligudem.
              </p>
              <p className="mt-4 text-lg md:text-2xl text-gray-200 font-medium text-center leading-relaxed">
                As a <span className="text-purple-400 font-semibold">Full-Stack Developer</span> and 
                <span className="text-blue-400 font-semibold"> UI/UX Designer</span>, I'm passionate about creating
                <span className="text-purple-400 font-semibold"> scalable web applications</span> and
                <span className="text-blue-400 font-semibold"> intuitive user interfaces</span>.
              </p>
              <p className="mt-4 text-lg md:text-2xl text-gray-200 font-medium text-center leading-relaxed">
                With a strong foundation in both <span className="text-purple-400 font-semibold">frontend</span> and
                <span className="text-blue-400 font-semibold"> backend</span> technologies, I strive to create
                <span className="text-gradient font-semibold"> seamless digital experiences</span> that leave a lasting impression.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="mt-12 p-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 md:gap-12 justify-items-center max-w-6xl mx-auto">
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">HTML5</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">CSS3</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">JavaScript</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">React</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">TailwindCSS</span>
          </div>
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">Bootstrap</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">Material-UI</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">MongoDB</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">Node.js</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">Express</span>
          </div>
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">Python</span>
          </div>
          ...
          <div className="flex flex-col items-center p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transform transition-all duration-300 hover:scale-110 hover:-translate-y-2 cursor-pointer group hover:shadow-xl hover:shadow-purple-500/20">
            ...
            <span className="text-white mt-4 font-medium opacity-80 group-hover:opacity-100">C++</span>
          </div>
      ...
      <div className="mt-20 p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="group relative overflow-hidden rounded-xl bg-white/5 p-4 hover:bg-white/10 transition-all duration-500 transform hover:scale-[1.02] hover:-translate-y-1">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-purple-300 transition-colors duration-300">Swiggy Website</h3>
              <p className="text-gray-300 mb-4">A modern Swiggy website built with React and TailwindCSS, featuring smooth animations and responsive design.</p>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="px-3 py-1 text-sm bg-purple-500/20 text-purple-300 rounded-full">React</span>
                <span className="px-3 py-1 text-sm bg-blue-500/20 text-blue-300 rounded-full">TailwindCSS</span>
                <span className="px-3 py-1 text-sm bg-green-500/20 text-green-300 rounded-full">JavaScript</span>
              </div>
              <a href="https://swiggy-clone-react-mu.vercel.app/" target="_" className="inline-flex items-center text-purple-400 hover:text-purple-300 transition-colors duration-300">
                View Project 
          ...
          <div className="group relative overflow-hidden rounded-xl bg-white/5 p-4 hover:bg-white/10 transition-all duration-500 transform hover:scale-[1.02] hover:-translate-y-1">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-blue-300 transition-colors duration-300"> Resort Booking Website</h3>
              <p className="text-gray-300 mb-4">A full-stack Resort Booking Website with user authentication, Booking management, and payment integration.</p>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="px-3 py-1 text-sm bg-green-500/20 text-green-300 rounded-full">Node.js</span>
                <span className="px-3 py-1 text-sm bg-blue-500/20 text-blue-300 rounded-full">React</span>
                <span className="px-3 py-1 text-sm bg-green-500/20 text-green-300 rounded-full">MongoDB</span>
                <span className="px-3 py-1 text-sm bg-green-500/20 text-blue-300 rounded-full">TailwindCSS</span>
              </div>
              <a href="https://next-resort-project.vercel.app/login" target="_" className="inline-flex items-center text-blue-400 hover:text-blue-300 transition-colors duration-300">
                View Project
                <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
          ...
          <div className="group relative overflow-hidden rounded-xl bg-white/5 p-4 hover:bg-white/10 transition-all duration-500 transform hover:scale-[1.02] hover:-translate-y-1">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-green-300 transition-colors duration-300">Task Management App</h3>
              <p className="text-gray-300 mb-4">A collaborative task management application with real-time updates and team collaboration features.</p>
              <div className="flex flex-wrap gap-2 mb-4">
                <span className="px-3 py-1 text-sm bg-yellow-500/20 text-yellow-300 rounded-full">Express</span>
                <span className="px-3 py-1 text-sm bg-blue-500/20 text-blue-300 rounded-full">React</span>
                <span className="px-3 py-1 text-sm bg-purple-500/20 text-purple-300 rounded-full">Socket.io</span>
              </div>
              <a href="#" className="inline-flex items-center text-green-400 hover:text-green-300 transition-colors duration-300">
                View Project
                <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
        ...
        <div className="text-center mt-12">
          <a href="#" className="inline-flex items-center px-6 py-3 rounded-full bg-gradient-to-r from-purple-600 to-blue-500 text-white font-semibold hover:from-purple-700 hover:to-blue-600 transform hover:scale-105 transition-all duration-300 group">
            View All Projects
            <svg className="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" />
            </svg>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          <div className="relative group">
            ...
            >
              ...
              {formStatus === 'sending' && (
                <p className="text-yellow-400 text-center">Sending message...</p>
              )}
              {formStatus === 'success' && (
